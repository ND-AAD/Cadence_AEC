...
DOOR_PROPERTY_ALIASES: dict[str, str] = {
    ...
    # Fire rating
    "fr": "fire_rating",
    "fire_rate": "fire_rating",
    "rating": "fire_rating",
    "f.r.": "fire_rating",
    "fire_rated": "fire_rating",
    "fire_resistance": "fire_rating",
    # Type
    "door_type": "type",
    "dt": "type",
    "style": "type",
    ...
    "lockset": "lock_function",
    "lock_type": "lock_function",
    # Level
    "floor": "level",
    "story": "level",
    "flr": "level",
    # Rebate (also called rabbet)
    "rebate_width": "rebate_width",
    "rabbet_width": "rebate_width",
    "rebate_height": "rebate_height",
    "rabbet_height": "rebate_height",
    "rebate_w": "rebate_width",
    "rebate_h": "rebate_height",
    # Panel
    "panel": "panel_type",
...
ROOM_PROPERTY_ALIASES: dict[str, str] = {
    ...
    "sq_ft": "area",
    "area_sf": "area",
    "floor_finish": "finish_floor",
    "flr_finish": "finish_floor",
    "wall_finish": "finish_wall",
    "wl_finish": "finish_wall",
    "ceiling_finish": "finish_ceiling",
    "clg_finish": "finish_ceiling",
    "clg_height": "ceiling_height",
